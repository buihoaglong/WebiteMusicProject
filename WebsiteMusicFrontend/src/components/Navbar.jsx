    ...
    <>
      <div className="w-full flex justify-between items-center font-semibold">
        ...
        <div className="flex items-start gap-4">
          ...
          <p className="bg-black py-1 px-3 rounded-full text-[15px] cursor-pointer">
            Install App
          </p>
          <p className="bg-purple-500 text-black w-7 h-7 rounded-full flex flex-items items-center justify-center ">
            D
          </p>
        </div>
      </div>
